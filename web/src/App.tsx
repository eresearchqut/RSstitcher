        ...
        <header className="mb-8">
          ...
          <div className="mt-3 flex flex-col gap-1 text-sm text-gray-400">
            ...
            >
              ...
              <span>
                RSstitcher: Seamless merging 2D diffraction frames for Wide
                Range Reciprocal Space Mappings
                <br />
                <span className="text-gray-500">
                  Xiaodong Wang, Michael W. M. Jones, Adam Smith &middot;
                  arXiv:2511.08265
                </span>
              </span>
            </a>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-600">
                Template vars: {"{type}"}, {"{mode}"}, {"{scale}"},{" "}
                {"{delta_s}"}, {"{wavelength_a}"}, {"{pixel_mm}"},{" "}
                {"{detector_distance_mm}"}, {"{phi0_deg}"},{" "}
                {"{theta_pixel_rad}"}, {"{n_decimals}"}, {"{blur_pixels}"},{" "}
                {"{n_files}"}
              </p>
            </div>
